...
In order to begin the project, I drew out a rough sketch of the diagram given on a scrap piece of paper. I went few a couple designs and decided to go with the second one which has a singular beam running across from point A to point C. I chose this because it was unique, and could pose a challenge to me. 
## Analyze
